...
def generate_lotto_story():
    try:
        ...
        - 유머러스하고 과장된 상상을 환영합니다.
        - 현실성과 판타지를 뒤섞은 황당한 스토리도 좋습니다.
        - 예시:
            - '당첨되자마자 알록달록 롤러블레이드를 사고, 동네 한 바퀴를 돌며 "나 돈 많아!"를 외쳤다.'
            - '부장님한테 사직서를 보내고, 오마카세 풀코스를 먹으며 인생 2막을 계획했다.'
            - '통장에 찍힌 금액을 보고 눈물이 났다. 그런데 기쁨이 아니라 너무 많아서 무서운 눈물이었다.'
